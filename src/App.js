            ...
            <div className="list-books-content">
              <div>
                <div className="bookshelf">
                  ...
                  <div className="bookshelf-books">
                    <ol className="books-grid">
                      ...
                      <Book title = {this.state.Books[0].title} author = {this.state.Books[0].autor} coverUrl = {this.state.Books[0].coverUrl} />
                  
                      <Book title = {this.state.Books[1].title} author = {this.state.Books[1].autor} coverUrl = {this.state.Books[1].coverUrl} />
                ...
                <div className="bookshelf">
                  ...
                  <div className="bookshelf-books">
                    <ol className="books-grid">
                      <Book title = {this.state.Books[2].title} author = {this.state.Books[2].autor} coverUrl = {this.state.Books[2].coverUrl} />
                     
                      <Book title = {this.state.Books[3].title} author = {this.state.Books[3].autor} coverUrl = {this.state.Books[3].coverUrl} />
                    </ol>
                  </div>
                </div>
                <div className="bookshelf">
                  ...
                  <div className="bookshelf-books">
                    <ol className="books-grid">
                     ...
                     <Book title = {this.state.Books[4].title} author = {this.state.Books[4].autor} coverUrl = {this.state.Books[4].coverUrl} />
                     
                      <Book title = {this.state.Books[5].title} author = {this.state.Books[5].autor} coverUrl = {this.state.Books[5].coverUrl} />
                      
                      <Book title = {this.state.Books[6].title} author = {this.state.Books[6].autor} coverUrl = {this.state.Books[6].coverUrl} />
